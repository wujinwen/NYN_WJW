//
//  NYNZhuSuDetailViewController.m
//  NetFarmCommune
//
...
@interface NYNZhuSuDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *ZhuSuTable;
@property (nonatomic,strong) NYNGouMaiView *bottomView;

@end

@implementation NYNZhuSuDetailViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            farmLiveTableViewCell.titleLabe.text = @"入住日期";
