...
@implementation FTExerciseTableViewCell
...
- (void)awakeFromNib {
    ...
    UILabel *kucun = [[UILabel alloc]initWithFrame:CGRectMake(titleLabel.left, addressLabel.bottom + JZHEIGHT(33), JZWITH(60), JZHEIGHT(10))];
    kucun.text = @"总面积 8Km";
...
-(void)setModel:(NYNCategoryPageModel *)model{
    ...
    self.kucun.text = [NSString stringWithFormat:@"库存 %@%@",model.stock,model.unitName];
