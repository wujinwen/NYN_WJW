...
-(UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 60+40, SCREENWIDTH, SCREENHEIGHT-60-43) style:UITableViewStylePlain];
...
-(PlayTitleView *)playView{
    if (!_playView) {
        _playView = [[PlayTitleView alloc]initWithFrame:CGRectMake(0, 43, SCREENWIDTH, 40)];
