...
//   _peopleLabel.text =[NSString stringWithFormat:@"人数%@",[MyControl timeWithTimeIntervalString:model.startDate],[MyControl timeWithTimeIntervalString:model.startDate]]
