...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        [selectButton setImage:[UIImage imageNamed:@"tanmubutton"] forState:UIControlStateNormal];
...
-(void)toggle
{
    if(!_state)
    {
        [selectButton setImage:[UIImage imageNamed:@"tuanmubutton1"] forState:UIControlStateNormal];
