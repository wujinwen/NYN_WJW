...
@implementation NYNMeTudiTableViewCell
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    ...
    NSString *sqsq = @"¥ 1/㎡/月";
    youshangjiaojiageLabel.attributedText = [MyControl CreateNSAttributedString:sqsq thePartOneIndex:NSMakeRange(0, 3) withColor:Colorf8491a withFont:[UIFont systemFontOfSize:15] andPartTwoIndex:NSMakeRange(3, sqsq.length - 3) withColor:Color686868 withFont:[UIFont systemFontOfSize:11]];
