...
@implementation NYNNongChangTableViewCell
...
- (void)awakeFromNib {
    ...
    UILabel *youshangjiaojiageLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREENWIDTH - JZWITH(10) - JZWITH(100), JZHEIGHT(10), JZWITH(100), JZHEIGHT(12))];
    youshangjiaojiageLabel.textAlignment = 2;
    NSString *sqsq = @"¥2.5/kg";
    youshangjiaojiageLabel.attributedText = [MyControl CreateNSAttributedString:sqsq thePartOneIndex:NSMakeRange(0,4) withColor:Colorf8491a withFont:[UIFont systemFontOfSize:11] andPartTwoIndex:NSMakeRange(4, sqsq.length - 4) withColor:Color686868 withFont:[UIFont systemFontOfSize:11]];
