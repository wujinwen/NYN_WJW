...
@implementation NYNMeHuoDongTableViewCell
...
- (void)awakeFromNib {
    ...
    UILabel *youshangjiaojiageLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREENWIDTH - JZWITH(10) - JZWITH(50), JZHEIGHT(10), JZWITH(50), JZHEIGHT(12))];
    youshangjiaojiageLabel.textAlignment = 2;
    NSString *sqsq = @"¥30";
    youshangjiaojiageLabel.attributedText = [MyControl CreateNSAttributedString:sqsq thePartOneIndex:NSMakeRange(0, 1) withColor:Colorf8491a withFont:[UIFont systemFontOfSize:11] andPartTwoIndex:NSMakeRange(1, sqsq.length - 1) withColor:Colorf8491a withFont:[UIFont systemFontOfSize:15]];
    [self.contentView addSubview:youshangjiaojiageLabel];
}
