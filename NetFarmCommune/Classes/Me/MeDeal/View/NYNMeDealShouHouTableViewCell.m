//
//  NYNMeDealShouHouTableViewCell.m
//  NetFarmCommune
//
...
@implementation NYNMeDealShouHouTableViewCell
...
- (void)awakeFromNib {
    ...
    UIView *addLine = [[UIView alloc]initWithFrame:CGRectMake(0, lineTwo.bottom + JZHEIGHT(36), SCREENWIDTH, 0.5)];
    addLine.backgroundColor = BackGroundColor;
    [self.contentView addSubview:addLine];
    
    UILabel *dingdanhaoLabel = [[UILabel alloc]initWithFrame:CGRectMake(JZWITH(10), JZHEIGHT(13) + addLine.bottom, SCREENWIDTH - JZWITH(20), JZHEIGHT(11))];
    dingdanhaoLabel.text = @"订单编号：20170212211311551";
    dingdanhaoLabel.font = JZFont(11);
    dingdanhaoLabel.textColor = Color888888;
    [self.contentView addSubview:dingdanhaoLabel];
    
    
    UILabel *huoyundanhaoLabel = [[UILabel alloc]initWithFrame:CGRectMake(JZWITH(10), JZHEIGHT(10) + dingdanhaoLabel.bottom, SCREENWIDTH - JZWITH(20), JZHEIGHT(11))];
    huoyundanhaoLabel.text = @"货运单号：20170212211311551";
    huoyundanhaoLabel.font = JZFont(11);
    huoyundanhaoLabel.textColor = Color888888;
    [self.contentView addSubview:huoyundanhaoLabel];
    
    UIView *lineThree = [[UIView alloc]initWithFrame:CGRectMake(0, addLine.bottom + JZHEIGHT(55), SCREENWIDTH, 0.5)];
    ...
    [pingjiabt setTitle:@"评价" forState:0];
