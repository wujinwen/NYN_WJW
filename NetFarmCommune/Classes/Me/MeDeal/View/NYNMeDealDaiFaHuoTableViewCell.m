//
//  NYNMeDealDaiFaHuoTableViewCell.m
//  NetFarmCommune
//
...
@implementation NYNMeDealDaiFaHuoTableViewCell
...
- (void)awakeFromNib {
    ...
    shouhuozhuangtaiLabel.text = @"待发货";
...
//    
    ...
    [shanchubt setTitle:@"申请退款" forState:0];
...
//
    ...
    [pingjiabt setTitle:@"查看物流" forState:0];
...
- (void)click:(UIButton *)sender{
    ...
    if (self.ccblock) {
        self.ccblock(i,_goodsDealModel);
    }
}
