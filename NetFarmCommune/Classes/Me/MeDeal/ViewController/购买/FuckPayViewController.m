...
@interface FuckPayViewController ()<UITableViewDelegate,UITableViewDataSource,WXApiDelegate,DealPasswordSetViewDelagate,ForgetPasswordViewDelagate>
{
    NSTimer* time;
}
...
@implementation FuckPayViewController
...
- (void)viewDidLoad {
    ...
    self.bottomView.heJiLabel.text = [NSString stringWithFormat:@"¥%ld",self.model.orderAmount];
        ...
        self.bottomView.goumaiBlock = ^(NSString *strValue) {
            ...
            switch (weakSelf.num) {
                ...
                case 1:
                {
                    ...
                    //typeS
                    NSDictionary *dic = @{@"orderSn":weakSelf.model.orderSn,@"payOrderType":typeS};
                ...
                case 2:
                {
                    ...
                    NSDictionary *dic = @{@"body":weakSelf.model.farmName,
                                          @"out_trade_no":weakSelf.model.orderSn,
                                          @"total_fee":[NSString stringWithFormat:@"%.0f",weakSelf.model.orderAmount  * 100],
...
#pragma mark--DealPasswordSetViewDelagate
 ...
 -(void)checkClick:(NSString*)password{
        NSDictionary * dic =@{@"passwd":[self md5:VALID_STRING(password)],@"payType":@"pay",@"orderSn":self.model.orderSn,@"payOrderType":@"NORMAL"};
