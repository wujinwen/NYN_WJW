...
- (void)awakeFromNib {
    ...
    UILabel *zhuangTaiLabel = [[UILabel alloc]initWithFrame:CGRectMake(titLabel.left, titLabel.bottom + JZHEIGHT(18), JZWITH(100), JZHEIGHT(13))];
    ...
    UILabel *shouhuoriqiLabel = [[UILabel alloc]initWithFrame:CGRectMake(titLabel.left, zhuangTaiLabel.bottom + JZHEIGHT(25), JZWITH(120), JZHEIGHT(11))];
