//
//  NYNMyFarmZhongZhiViewController.m
//  NetFarmCommune
//
...
@interface NYNMyFarmZhongZhiViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *myFarmZhongTable;
@property (nonatomic,strong) NSArray *titleArr;
@property (nonatomic,strong) NYNMyFarmTuDiZiLiaoModel *model;
@end

@implementation NYNMyFarmZhongZhiViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            farmLiveTableViewCell.detailLabel.text = self.model.orderName;

        }else if (indexPath.row == 1){
            farmLiveTableViewCell.detailLabel.text = self.model.minorProductName;
