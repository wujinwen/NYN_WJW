//
//  NYNZuDiZhongZhiViewController.m
//  NetFarmCommune
//
...
@interface NYNZuDiZhongZhiViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *zuDiZhongZhiTable;
@property (nonatomic,strong) NYNZuDiZhonZhiModel *model;
@end

@implementation NYNZuDiZhongZhiViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            NYNMyFarmZuZhongOneTableViewCell *farmLiveTableViewCell = [tableView dequeueReusableCellWithIdentifier:@"activityCell"];
            if (farmLiveTableViewCell == nil) {
                farmLiveTableViewCell = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([NYNMyFarmZuZhongOneTableViewCell class]) owner:self options:nil].firstObject;
            }
            farmLiveTableViewCell.titleNameLabel.text = @"租赁土地";
            ...
            farmLiveTableViewCell.priceLabel.attributedText = [MyControl CreateNSAttributedString:str thePartOneIndex:NSMakeRange(0, str1.length) withColor:Colorf8491a withFont:[UIFont systemFontOfSize:14] andPartTwoIndex:NSMakeRange(str1.length , str2.length) withColor:Color888888 withFont:[UIFont systemFontOfSize:14]];
            
            farmLiveTableViewCell.countLabel.text = [NSString stringWithFormat:@"面积：%@㎡",self.model.majorProductQuantity];
            farmLiveTableViewCell.durationLabel.text = [NSString stringWithFormat:@"时长：%@天",self.model.majorProductRate];
            ...
            farmLiveTableViewCell.titleLabels.text = @"土地名片";
        ...
        if (indexPath.row == 0) {
            ...
            farmLiveTableViewCell.titleLabels.text = @"选择种子";
            farmLiveTableViewCell.countLabels.text = [NSString stringWithFormat:@"%@ ×%@",self.model.minorProductName, self.model.minorProductQuantity];
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"¥%@",self.model.minorProductPrice];
            return farmLiveTableViewCell;
            ...
            farmLiveTableViewCell.titleLabels.text = @"种植方案";
            farmLiveTableViewCell.countLabels.text = @"省心方案";
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"%@元",self.model.programTotalPrice];
...
//            farmLiveTableViewCell.countLabels.text = @"省心方案";
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"%@元",self.model.managerName];
            
            farmLiveTableViewCell.PriceLabelWith.constant = 150;
            ...
            //            farmLiveTableViewCell.countLabels.text = @"省心方案";
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"%@元",self.model.cameraPrice];
            return farmLiveTableViewCell;
            ...
            if (self.model.signboardPrice == nil) {
                self.model.signboardPrice = @"0";
            }
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"%@元",self.model.signboardPrice];
            return farmLiveTableViewCell;
        }
            ...
            farmLiveTableViewCell.titleLabels.text = @"作物保险";
        ...
        if (indexPath.row == 0) {
            ...
            if (self.model.freight) {
                self.model.freight = @"0";
            }
            
            farmLiveTableViewCell.countLabels.text = [NSString stringWithFormat:@"¥%@",self.model.freight];
            farmLiveTableViewCell.priceLabels.text = [NSString stringWithFormat:@"(¥%@/㎡)",self.model.freight];
//            ,self.model.majorProductUnit
            return farmLiveTableViewCell;
