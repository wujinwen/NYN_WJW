//
//  NYNMeYiJianFanKuiViewController.m
//  NetFarmCommune
//
...
@interface NYNMeYiJianFanKuiViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView *touziTable;

@end

@implementation NYNMeYiJianFanKuiViewController
